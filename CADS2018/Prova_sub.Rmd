---
title: "Prova Substitutiva de Coleta e Análise de Dados Secundários"
...
7. (1 ponto) Por que não utilizamos nomes de variável iguais para a diferença entre as notas de 1999 e 2000 no data.frame oriundo da população (questão 4) e no data.frame oriundo da expansão da amostra (questão 5)?
...
9. (1 ponto) O que se pode concluir do gráfico?
